                ...
                new EventHandler<ActionEvent>(){
                    public void handle(ActionEvent event) {
                        ...
                        if (musicCanPlay) {
                            ...
                            musicPlayerThread = new Thread(new ThreadEx2(soundFile));
                            musicPlayerThread.start();
                            musicCanPlay = false;
                        } else {
                            // check if initial or previous sound file has started and finished
                            if (!musicPlayerThread.isAlive()) {
                                ...
                                musicPlayerThread.start();
                                musicCanPlay = false;
                            } else System.out.println("Music is already playing");
                        }
                    }
                });
